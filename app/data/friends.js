...
var randomObj = {
    ...
    generateFriends: function () {
        for (var i = 0; i < friendsNum; i++) {
            ...
            randomFriend = new Friend(randomName, "#", randomRes, totalScore);
