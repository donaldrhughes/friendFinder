...
var dataObj = {
    friend0: new Friend(randomName, "#", randomRes, totalScore),
    friend1: "friend1",
    friend2: "friend2",
    friend3: "friend3",
    friend4: james,
...
randomObj.generate();
dataObj.friend1 = new Friend(randomName, "#", randomRes, totalScore)
randomObj.generate();
dataObj.friend2 = new Friend(randomName, "#", randomRes, totalScore)
randomObj.generate();
dataObj.friend3 = new Friend(randomName, "#", randomRes, totalScore)


var newFriend = new Friend("New Friend", "#", [3, 3, 3, 3, 3, 3, 3, 3, 3, 3], totalScore);
